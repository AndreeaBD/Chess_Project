...
public class ChessBoardTest extends TestCase {
    ...
    public void test_Avoids_Duplicate_Positioning() {
        ...
        testSubject.addPieceOnChessBoard(firstPawn, 6, 3, firstPawn.getPieceColor());
        testSubject.addPieceOnChessBoard(secondPawn, 6, 3, secondPawn.getPieceColor());
    ...
    public void testLimits_The_Number_Of_Pawns() {
        for (int i = 0; i < 10; i++) {
            ...
            testSubject.addPieceOnChessBoard(pawn, 6 + row, i % ChessBoard.MAX_BOARD_WIDTH, pawn.getPieceColor());
            if (row < 1) {
